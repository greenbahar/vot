...
import GreenbaharVotGreenbaharVotVot from './greenbahar/vot/greenbahar.vot.vot'
...
export default { 
  ...
  GreenbaharVotGreenbaharVotVot: load(GreenbaharVotGreenbaharVotVot, 'greenbahar.vot.vot'),
